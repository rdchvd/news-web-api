...
class Post(models.Model):
    ...
    votes = models.ManyToManyField('auth.User', through='Vote', related_name='votes_all')
...
class Vote(models.Model):
    ...
    """
    post = models.ForeignKey(Post, related_name='votes_post', on_delete=models.CASCADE)
    user = models.ForeignKey('auth.User', related_name='votes_user', on_delete=models.CASCADE, null=True)
